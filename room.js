...
export async function startPickingPhase(roomCode, playerIds) {
...
export async function nextRound(roomCode, playerIds) {
  await startPickingPhase(roomCode, playerIds);
}
